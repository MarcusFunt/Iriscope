...
rpicam-still --raw --immediate --nopreview \
  --shutter 8000 --gain 1 --awbgains 1.8,1.4 --denoise off \
...
iriscope capture --subject S001 --eye right --count 16 --shutter 6000 --gain 1
...
```powershell
python -m pip install -e ".[web,ssh,dev]"
cd web
npm install
```
